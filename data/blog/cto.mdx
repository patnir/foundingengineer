...
3. They want to rebuild fundamental technology to solve a problem (like an ORM, graph database, programming language, query language, etc.). I've personally seen this go very wrong.
4. They don't ask about the customer and use the product to understand their pain points.

### Be Prepared to Fire Early

Be prepared to fire early. The best companies make decisive hiring and firing decisions. If someone isn’t a culture fit, isn’t pulling their weight, or seems absent, consider letting them go. It’s not a reflection on the person—they might be incredible but not the right fit at this time.

### Conclusion

I personally don't think CTOs build companies at early stages, engineers do. When are you hiring, be very choosy, but if the right person comes along, close immediately.
